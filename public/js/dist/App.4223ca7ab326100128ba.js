...
function App() {
  ...
  const [sex, setSex] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const [species, setSpecies] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  ...
  const [reservedForAdoption, setReservedForAdoption] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  const handleDeleteAnimal = async id => {
    try {
      await axios.delete("/api/animals/".concat(id));
      fetchAnimals();
    } catch (error) {
...
/******/ })()
;
//# sourceMappingURL=App.a89158f1f2fd9c1089d2ed396c6c657f.js.map